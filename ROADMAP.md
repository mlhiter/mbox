...
- Done: CLI `tasks wait` polling helper, including optional `--require-success` exit-code gating, for automation scripts that need SDK-style task terminal-state waiting without parsing the NDJSON watch stream.
